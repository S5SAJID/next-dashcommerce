...
export default function DashboardSubdomainInput({ className, defaultValue }: DashboardSubdomainInputProps) {
  ...
  const { status, error } = useSubdomainAvailability(subdomainFormVal, 500, defaultValue);
