...
import { storeLayoutSettingsSchema, StoreLayoutSettingsSchemaType } from "./schema";
...
export default function StoreLayoutSettingsForm(props: StoreLayoutSettingsFormProps) {
    ...
    <Form {...form}>
      <form
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea {...field} placeholder="Welcome to Acme Store, your go-to destination for high-quality and premium products." />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ }) => (
            <FormItem>
              <FormLabel>Tags <span className="text-xs text-muted-foreground">(separated by comma)</span></FormLabel>
              <FormControl>
                <Input placeholder="acme" {...form.register("seo.tags", { setValueAs: (v) => (typeof v === "string" ? v.split(",").map((tag: string) => tag.trim()) : []) })} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <div className='relative'>
          ...
          <p className="mb-8 text-muted-foreground text-sm">Settings to customise the hero section of your store.</p>
          <div className='space-y-8'>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Description</FormLabel>
                  <FormControl>
                    <Textarea {...field} placeholder="Short Description for hero section" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div className="flex gap-4 justify-stretch w-full">
              <FormField
                control={form.control}
